...
| TC-REQ-017 | User 2026-06-20: commit, push, build link | GitHub branch/actions/release | Changes are committed, pushed, GitHub Actions APK build completes, and download link is reported. | Git/GitHub Actions/release verification | NOT DONE |

...
| HTML-09 | Typography and reusable icon dimensions have one semantic source | `assets/styles.css`, `assets/explore-discovery.css`, `assets/universe4/universe4.css` | Card primary/secondary/meta text, menu header/subheader/child text, and reusable icon sizes resolve through `:root` tokens while retaining distinct hierarchy | typography/icon contract test, full test suite, source inspection | NOT DONE |

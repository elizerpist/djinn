...
assert.match(index, /assets\/styles\.css\?rev=135/);
assert.match(index, /assets\/app\.js\?rev=143/);
assert.match(app, /initExpandableGalaxyOrb \} from '\.\/explore-galaxy-orb\.js\?rev=145';/);
...
assert.doesNotMatch(orb, /galaxy-orb-title/);

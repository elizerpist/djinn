...
assert.match(styles, /--type-size-7:\s*7\.7px/);
assert.match(styles, /--type-size-7-6:\s*8\.36px/);
assert.match(styles, /--type-size-8:\s*8\.8px/);
assert.match(styles, /--type-size-8-6:\s*9\.46px/);
assert.match(styles, /--type-size-9:\s*9\.9px/);
assert.match(styles, /--type-size-10:\s*11px/);
assert.match(styles, /--type-size-11:\s*12\.1px/);
assert.match(styles, /--type-size-19:\s*20\.9px/);
assert.match(styles, /--type-size-25:\s*27\.5px/);
...
assert.match(styles, /--icon-card-size:\s*37\.4px/);
assert.match(styles, /--icon-card-glyph-size:\s*19\.8px/);
assert.match(styles, /--icon-action-size:\s*38\.5px/);
assert.match(styles, /--icon-navigation-size:\s*37\.4px/);
